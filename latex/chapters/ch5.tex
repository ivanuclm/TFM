...
\begin{figure}[htbp]
  ...
  \includegraphics[width=1.0\textwidth]{figs/_borrador_gtfs_joins.png}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=1.0\textwidth]{figs/FastAPI_Docs4.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{figs/FRONTEND_RutasOSRM.jpeg}
  \caption{Rutas OSRM para los tres perfiles de transporte sobre Toledo.}
  \label{fig:osrm_rutas}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{figs/FRONTEND_RutasOTP.jpeg}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=1.0\textwidth]{figs/FRONTEND_GTFS_Horarios.jpg}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=1\textwidth]{figs/FRONTEND_Capas2.jpeg}
