...
La Tabla~\ref{tab:lpmc_features} detalla las variables de entrada del modelo, agrupadas según procedan de los servicios de enrutado (OSRM y OTP) o del perfil sociodemográfico aportado por el usuario, tal como se introdujo en la Sección~\ref{subsec:impl_lpmc_dataset}.
